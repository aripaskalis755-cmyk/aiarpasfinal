...
Original file is located at
    https://colab.research.google.com/drive/11qOpbOx41ZNkgSvkDZJdmyki1o_8-pDX
"""
...
# --- STYLE UTAMA (DARK MODE MODERN + GLASSMORPHISM DENGAN WARNA TEKS YANG KONTRASTIF) ---
st.markdown("""
<style>
    /* IMPORT FONTS */
    ...
    .title-section p {
        color: #cbd5e1;  /* lebih terang untuk kontras */
        font-size: 0.75rem;
        margin: 0;
        letter-spacing: 1px;
    }
    .live-clock {
        ...
        font-size: 0.9rem;
        font-weight: 500;
        color: #b9f3ff; /* lebih cerah */
    }

    /* KARTU INFO GEMPA + CUACA (MODERN) */
    .info-panel {
    ...
    .badge-danger {
        ...
        color: #fed7d7; /* merah muda terang */
    }

    /* CHAT AREA - SEPERTI AI MODERN */
    .stChatMessage {
    ...
    .stChatMessage p, .stChatMessage div {
        color: #f1f5f9 !important; /* teks putih kebiruan */
    }
...
# --- KONTEN UTAMA: 2 KOLOM (INFO KIRI, CHAT KANAN) ---
left_col, right_col = st.columns([1.2, 2.8], gap="large")

# --- DATA REAL-TIME (GEMPA, CUACA JAKARTA, PERINGATAN) ---
...
# TAMPILKAN INFO PANEL DI KOLOM KIRI
with left_col:
...
# --- KOLOM KANAN: CHAT UTAMA AI ARPAS ---
with right_col:
